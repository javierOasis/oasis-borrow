module.exports = [
  {
    inputs: [
      ...
      {
        internalType: 'contract AutomationBotStorage',
        name: '_automationBotStorage',
        type: 'address',
      },
    ],
  ...
  {
    inputs: [],
    name: 'automationBotStorage',
    outputs: [{ internalType: 'contract AutomationBotStorage', name: '', type: 'address' }],
