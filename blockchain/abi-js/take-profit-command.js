module.exports = [
  ...
  {
    inputs: [{ internalType: 'uint256', name: 'maxAcceptableBaseFeeInGwei', type: 'uint256' }],
    name: 'baseFeeIsValid',
  ...
  {
    inputs: [{ internalType: 'uint256', name: 'cdpId', type: 'uint256' }],
    name: 'getVaultAndMarketInfo',
    outputs: [
      { internalType: 'uint256', name: 'collRatio', type: 'uint256' },
      { internalType: 'uint256', name: 'nextCollRatio', type: 'uint256' },
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_cdpId', type: 'uint256' },
      { internalType: 'bytes', name: 'triggerData', type: 'bytes' },
    ],
  ...
  {
    inputs: [
      { internalType: 'uint16', name: 'triggerType', type: 'uint16' },
      { internalType: 'uint16', name: 'expectedTriggerType', type: 'uint16' },
    ],
